...
@NamedQueries({
    ...
    , @NamedQuery(name = "Company.findByImg", query = "SELECT c FROM Company c WHERE c.img = :img")
    , @NamedQuery(name = "Company.findByDescription", query = "SELECT c FROM Company c WHERE c.description = :description")
    , @NamedQuery(name = "Company.findByContactInfo", query = "SELECT c FROM Company c WHERE c.contactInfo = :contactInfo")})
